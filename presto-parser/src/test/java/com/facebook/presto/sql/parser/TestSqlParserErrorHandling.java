...
public class TestSqlParserErrorHandling
{
    ...
    public Object[][] getStatements()
    {
        return new Object[][] {
                ...
                {"select * from 'oops",
                 "line 1:15: mismatched input '''. Expecting: '(', 'LATERAL', 'MATCH', 'UNNEST', <identifier>"},
                {"select *\nfrom x\nfrom",
                ...
                {"select * from",
                 "line 1:14: mismatched input '<EOF>'. Expecting: '(', 'LATERAL', 'MATCH', 'UNNEST', <identifier>"},
                {"select * from  ",
                 "line 1:16: mismatched input '<EOF>'. Expecting: '(', 'LATERAL', 'MATCH', 'UNNEST', <identifier>"},
                {"select * from `foo`",
                ...
                {"SELECT * FROM ( ",
                 "line 1:17: mismatched input '<EOF>'. Expecting: '(', 'LATERAL', 'MATCH', 'UNNEST', <identifier>, <query>"},
                {"SELECT CAST(a AS )",
