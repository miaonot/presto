...
public class Neo4jTableLayoutHandle
        implements ConnectorTableLayoutHandle
{
    private final Neo4jTableHandle table;
    private final TupleDomain<ColumnHandle> tupleDomain;

    @JsonCreator
    public Neo4jTableLayoutHandle(
            @JsonProperty("table") Neo4jTableHandle table,
    ...
    @JsonProperty
    public Neo4jTableHandle getTable()
    {
        return table;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        Neo4jTableLayoutHandle that = (Neo4jTableLayoutHandle) o;
